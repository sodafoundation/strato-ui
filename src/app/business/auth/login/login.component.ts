    ...
    ngOnInit() {
        ...
        this.menuItems_tenant = [
            ...
            },
            {
                ...
                "description": "Buckets / Cloud Volumes / Cloud File Share",
                "routerLink": "/block",
                "joyrideStep" : "menuResource",
                "text" : "View and manage Buckets, Cloud Volumes, Cloud File shares that have been manually created or applied for through service templates.",
                "group" : true,
                "children" : [
                    {
                        "title" : "Buckets",
                    ...
                    {
                        "title" : "Cloud Volumes",
                        "routerLink": "/block/fromCloudVolume"
                    },
                    {
                        "title" : "Cloud File Share",
                        "routerLink": "/block/fromCloudFileShare"
                    }
                ]
            },
            {
