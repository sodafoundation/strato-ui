...
SODA Strato UI provides a GUI interface through which the users can experience various features and capabilities of the SODA Strato project. It provides an easy user setup and experience of all the key features integrated.
...
The dashboard is mainly for providing the first hand experience for SODA Strato. However, it could be referred for your production integrations

SODA Strato UI project is maintained by SODA Foundation directly.
