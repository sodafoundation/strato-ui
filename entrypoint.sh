...
echo "{\"hostIP\": \"$OPENSDS_S3_HOST\",\"hostPort\": \"$OPENSDS_S3_PORT\",\"servicePlansEnabled\": \"$STORAGE_SERVICE_PLAN_ENABLED\"}" >/var/www/html/assets/data/runtime.json
